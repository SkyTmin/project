...
- **Coco Money** - модуль для отслеживания доходов и расходов
  ...
  - **Исключение листов из общего баланса** (v1.4)
  - **Предварительные расходы** для планирования (v1.4)
  - Экспорт данных в текстовый формат
  - Поиск инструментов на главной странице
...
### Версия 1.4 (Текущая)
- Возможность исключения листов из общего баланса
- Предварительные расходы для планирования
- Улучшенная статистика с учетом исключений
- Обновленный экспорт данных

### Версия 1.3
- Улучшенные свайпы (требуют больше усилий)
- Постоянная сессия (365 дней)
- Исправлена совместимость с Android
- Поиск инструментов на главной странице
- Добавлена статистика

### Версия 1.2
- Новый дизайн с карточками листов
